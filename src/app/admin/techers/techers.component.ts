...
@Component({
  ...
  templateUrl: './techers.component.html',
  styleUrls: ['./techers.component.sass']

})
export class TechersComponent implements OnInit {
  ...
  columns: ITdDataTableColumn[] = [
    { name: 'first_name',  label: '工号', sortable: true, width: 150 },
    { name: 'last_name', label: '姓名', filter: true },
    { name: 'gender', label: '性别', hidden: false, sortable: false },
    { name: 'email', label: '电话', sortable: true, width: 250 },
    { name: 'balance', label: '邮件', numeric: true, format: DECIMAL_FORMAT },
  ];
